...
function BodyReader(options) {
    ...
    function getOutlineLvl(ppr) {
      const outlineLvl = ppr.first("w:outlineLvl");
      if (!outlineLvl) {
        return false;
      }
      const a = parseInt(outlineLvl.attributes['w:val']);
      return a;
    }
    ...
    var xmlElementReaders = {
        ...
        "w:pPr": function(element) {
            ...
            properties.outlineLvl = getOutlineLvl(element);
    ...
    function readTableCell(element) {
        return readXmlElements(element.children).map(function(children) {
            ...
            if (properties) {
              const cellShading = properties.firstOrEmpty("w:shd");
              if (cellShading) {
                backgroundColor = cellShading.attributes['w:fill'] ? `#${cellShading.attributes['w:fill']}` : ``;
              }
            }


            var cell = documents.TableCell(children, {colSpan: colSpan, backgroundColor: backgroundColor});
